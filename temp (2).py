...
import turtle
# This is a hacked version of setworldcoordinates that does not change the screen size.
# self is an instance of TurtleScreen.
...
def gcFreq(dna,window,t):
    ...
    t.goto(len(dna),5)   # draw the straight line first
...
def orf(dna, rf, t):
	'''Find all ORFs in reading frame rf = 0, 1, 2 (forward only), not including ORFs contained in other ORFs.'''
    t.goto(0,1+rf)
    t.down()
    t.color('red')
    inORF = 0
