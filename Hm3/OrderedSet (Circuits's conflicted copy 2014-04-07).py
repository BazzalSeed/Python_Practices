...
#---------------------------------------------------------------------------------
    def insert(self,x):
        '''pre: X is of the same type as the objects in OrderedSet
           ...
           exception: TypeError if X is not the same type as objects in OrderedSet
           
        '''
        
        #Raise TypeError if X is not the same type as the exiting elemtns in the set
        if len(self)!= 0 and not isinstance(x,type(self.set[0])):
            raise TypeError
